...
def txt_encode(text):
    ...
    file1 = open("Stegno Sample/TXT.txt","r+")
    nameoffile = input("Name for TXT file after Encryption: ")
...
def decode_txt_data():
    ...
    stego=input("Name of TXT file for Decryption: ")
    ...
    lengthd = len(temp)
    print("Length of encoded bits: ",lengthd)
    i=0
    a=0
    b=4
    c=4
    ...
    while i<len(temp):
        ...
        if(t3=='0110'):
            ...
            decimal_data = BinaryToDecimal(t4)
            final+=chr((decimal_data ^ 170) - 48)
    print("\nHidden message after Decryption: ",final)
...
def encode_img_data(img):
    data=input("Enter the data to be Encoded in Image: ")    
    if (len(data) == 0): 
        raise ValueError('Data entered to be encoded is empty')

    nameoffile = input("Name for IMAGE file after Encryption: :")
...
def img_steg():
    while True:  
        choice1 = int(input("\nIMAGE Stegnography\n1. Encode\n2. Decode\n3.Exit\nYou Chose: "))   
        if choice1 == 1:
            image=cv2.imread("Stegno Sample/IMAGE.jpg")
...
def main(): 
    while True:  
        choice1 = int(input("\nStegnography:\n1. IMAGE Stegnography\n2. TEXT Stegnography\n3. AUDIO Stegnography\n4. VIDEO Stegnography\n5. Exit\nYou Chose: "))   
        if choice1 == 1: 
            img_steg()
        elif choice1 == 2:
            txt_steg()
